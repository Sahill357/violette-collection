...
const SearchBox = () => {
  ...
  const names = [
...

    {
      ...
      type: "fragnance",
      heading: "No 1 ♥️",
      description: "I love VIOLETTA products and this is my go to. My skin feels amazing.It doesn't have a strong artificial fragrance, smells natural.I even spray it all over my face after makeup. This can go out of stock quickly so I always stock some.",
      stars: 5,
    },
...

    {
      ...
      description: "Awesome product! Since using a VIOLETTA skin care routine my skin has been noticeably softer, more even and my pores are smaller. I love this line! the exfoliating properties always makes me re-buy the product. AMAZING!!      ",
      stars: 5,
    },
